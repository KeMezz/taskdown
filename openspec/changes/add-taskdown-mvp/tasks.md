...
### 4.1 칸반 레이아웃
- [x] KanbanBoard 컴포넌트
- [x] KanbanColumn 컴포넌트 (헤더, 카운트)
- [x] 4컬럼 고정 레이아웃
- [x] 빈 컬럼 상태 표시

### 4.2 드래그앤드롭
- [x] dnd-kit DndContext 설정
- [x] SortableContext 컬럼별 설정
- [x] 컬럼 간 이동 핸들러
- [x] 컬럼 내 순서 변경 핸들러
- [x] DragOverlay 구현

### 4.3 sort_order 관리
- [x] 드롭 위치 기반 sort_order 계산
- [x] 배치 업데이트 로직
- [x] 낙관적 업데이트 (React Query)
...
### 6.1 TipTap 에디터 셋업
- [x] useTaskEditor 훅 구현
- [x] StarterKit 설정
- [x] 에디터 스타일링 (prose)

### 6.2 체크리스트 지원
- [x] TaskList, TaskItem 익스텐션 추가
- [x] 체크박스 토글 스타일링

### 6.3 코드 블록
- [x] CodeBlockLowlight 익스텐션 추가
- [x] lowlight 언어 설정
- [x] 코드 블록 스타일링

### 6.4 이미지 삽입
- [x] Image 익스텐션 추가
- [x] 이미지 업로드 핸들러 (Rust 연동)
- [x] 드래그앤드롭 이미지 삽입
- [x] 클립보드 이미지 붙여넣기
...
### 7.2 리마인더 CRUD
- [x] 태스크별 알림 수동 생성/삭제
- [x] 리마인더 CRUD 훅 (useReminders, useCreateReminder, useDeleteReminder)
- [x] 과거 시간 알림 검증
